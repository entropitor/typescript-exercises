...
export const exerciseStructures: Record<string, FileTree> = {
    ...
    17: {
        '/index.ts': {
            content: require('!!raw-loader!../exercises/17/index.ts').default,
            solution: require('!!raw-loader!../exercises/17/index.solution.ts').default
        },
        '/test.ts': {
            content: require('!!raw-loader!../exercises/17/test.ts').default,
            readOnly: true
        },
        ...typeAssertions
    },
    ...
    19: {
        '/index.ts': {
            content: require('!!raw-loader!../exercises/19/index.ts').default,
            solution: require('!!raw-loader!../exercises/19/index.solution.ts').default
        },
        '/test.ts': {
            content: require('!!raw-loader!../exercises/19/test.ts').default,
            readOnly: true
        },
        ...typeAssertions
    },
    20: {
        '/index.ts': {
            content: require('!!raw-loader!../exercises/20/index.ts').default,
            solution: require('!!raw-loader!../exercises/20/index.solution.ts').default
        },
        '/test.ts': {
            content: require('!!raw-loader!../exercises/20/test.ts').default,
            readOnly: true
        },
        ...typeAssertions
    },
    21: {
        '/index.ts': {
            ...
            solution: require('!!raw-loader!../exercises/21/index.solution.ts').default
        },
        '/test.ts': {
            content: require('!!raw-loader!../exercises/21/test.ts').default,
            readOnly: true
        },
        ...typeAssertions
    }
